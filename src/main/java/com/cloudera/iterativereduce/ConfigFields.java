...
public class ConfigFields {
  ...
  public static final String APP_CONFIG_FILE = "iterativereduce.app.properties";
  public static final String APP_ALLOCATION_MAX_ATTEMPTS = "iterativereduce.allocation.maxattempts";
  public static final String JAR_PATH = "iterativereduce.jar.path";
